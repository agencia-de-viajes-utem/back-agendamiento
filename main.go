...
func main() {
	...
	handler := middleware.CORSHandler([]string{"http://localhost:3000", "https://agendamiento.lumonidy.studio"}, r)
	...
	restrictedHandler := middleware.RestrictedHandler(restrictedRoutes, []string{"http://localhost:3000", "https://agendamiento.lumonidy.studio"}, handler)
